        ...
        public async Task<Result> CancelDeliveryAsync(DeliveryDetailDTO model)
        {
            ...
            if(delivery != null)
            {
                ...
                if(wallet != null)
                {
                    ...
                    WalletTransaction transaction = new WalletTransaction(wallet.Id, Core.Enum.TransactionType.FundRequest, delivery.TotalAmount,
                    "Withdrwal", transactinref, Core.Enum.WalletTransactionStatus.Successful);
